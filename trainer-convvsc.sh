...
#BSUB -o testconvvsc_fold_2%J.out
#BSUB -e testconvvsc_fold_2%J.err
# -- end of LSF options --
...
python3 /zhome/a2/4/155672/Desktop/DeepLearning/SparseVAE-Cell-Images/src/train-convvsc.py --dataset stratifiedcell --epochs 80 --report-interval 5 --lr 0.001 --latent-size 200 --hidden-size 400 --beta-delta 0.0001 --fold-number=1