...
# Load all data
df = pd.read_csv("/zhome/a2/4/155672/Desktop/DeepLearning/SparseVAE-Cell-Images/bbbc021/singlecell/metadata.csv")
...
for train_index, val_index in skf.split(df, target):
  ...
  train_fold_df.to_csv('/zhome/a2/4/155672/Desktop/DeepLearning/SparseVAE-Cell-Images/datasplit/' + 'train_fold_' + str(fold_no) + '.csv')
  test_fold_df.to_csv('/zhome/a2/4/155672/Desktop/DeepLearning/SparseVAE-Cell-Images/datasplit/' + 'test_fold_' + str(fold_no) + '.csv')
