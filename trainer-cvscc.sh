...
python3 /zhome/a2/4/155672/Desktop/DeepLearning/SparseVAE-Cell-Images/src/train-cvaec.py --dataset cell --epochs 500 --report-interval 30 --lr 0.001 --latent-size 200 --hidden-size 400 --do-not-resume