...
python3 /zhome/0f/f/137116/Desktop/DeepLearningProject/SparseVAE-Cell-Images/src/train-convvae.py --dataset cell --epochs 500 --report-interval 20 --lr 0.001 --do-not-resume